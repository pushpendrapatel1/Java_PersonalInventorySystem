 ...
 */
public class Viewexpensescategory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<div class='table_container'>");
                  out.println(" <a href='expensescategory' class='backbutton datatable'>&#8592</a>");
            ...
            for (ExpensesCategoryBean el : al) {
                ...
                out.println("<tr>");
                out.println("<td>" + el.getExp_catname() + "</td>");
                out.println("<td>" + el.getExp_catdetails() + "</td>");
                out.println("<td><a href='UpdateExpensesCategory?exp_catid=" + el.getExp_catid() + "' id='edit'>edit</a></td>");
                out.println("<td><a href='DeleteExpensesCategory?exp_catid=" + el.getExp_catid() + "' id='delete'>delete</a></td>");
                out.println("</tr>");
            }
            out.println("</table>");
            out.println("</div>");
