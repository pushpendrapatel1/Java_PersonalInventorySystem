...
public class BankData extends HttpServlet {
  ...
  out.println("<!DOCTYPE html>");
            ...
            out.println(" <h1>BankBook</h1>");
           
            out.println("<form action='BankData'>");
            ...
            out.println("  <tr>");
            out.println("   <td id='heading'>BankBook</td>");
            ...
            double clsamount=0;
            String opr="Pay";
             ArrayList<BankBookBean>  x= bd.FindAllBankBookDatewise(sdate,edate, userid);
