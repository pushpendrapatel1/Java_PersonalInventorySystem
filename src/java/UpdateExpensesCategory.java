    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           out.println("    <li><a href='Home'>Home  </a></li>");
            ...
            ExpensesCategoryBean x=ed.FindbyAcid(exp_catid);
            out.println("<div class='item' id='item-3'>");
            out.println("<form action='EditExpensesController' method='post'>");            
             out.println("<div class='container'>");
            out.println("<h1> Expenses Category</h1>");
            out.println("<table class='datatable table1'>");
             out.println(" <input type='hidden'   name='expid' value='"+x.getExp_catid()+"' required>");
            ...
            out.println(" <input type='text' placeholder='Category Name' name='c_name' value='"+x.getExp_catname()+"' required>");
            out.println(" </td>");
            out.println(" </tr>");
            out.println(" <tr>");
            out.println(" <td>");
            ...
            out.println(" </td>");
            out.println(" <td colspan='2'>");
            out.println("  <input type='text' placeholder='Category Details' name='c_details' value='"+x.getExp_catdetails()+"' required>");
            out.println(" </td>");
            out.println(" </tr>");
            ...
            out.println(" </td>");
            out.println(" <td>");
            out.println("<a href='Viewexpensescategory' class='viewtable'>View ALL</a>");
            out.println(" </td>");
            out.println("  </div>");
            out.println(" </table>");
            out.println("  </div>");
