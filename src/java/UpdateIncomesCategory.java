 ...
 */
public class UpdateIncomesCategory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            IncomeCategoryDao ed = new IncomeCategoryDao();
             int inccatid=Integer.parseInt(request.getParameter("inc_catid"));
            IncomeCategoryBean  x=ed.FindbyId(inccatid);
            out.println("<div class='item' id='item-3'>");
            out.println("<form action='EditIncomesController' method='post'>");            
             out.println("<div class='container'>");
            out.println("<h1> Incomes Category</h1>");
            out.println("<table class='datatable table1'>");
             out.println(" <input type='hidden'   name='catid' value='"+x.getInc_catid()+"' required>");
            ...
            out.println(" <input type='text' placeholder='Category Name' name='catname' value='"+x.getInc_catname()+"' required>");
            out.println(" </td>");
            out.println(" </tr>");
            out.println(" <tr>");
            out.println(" <td>");
            ...
            out.println(" </td>");
            out.println(" <td colspan='2'>");
            out.println("  <input type='text' placeholder='Category Details' name='catdetails' value='"+x.getInc_catdetails()+"' required>");
            out.println(" </td>");
            out.println(" </tr>");
            out.println(" <div class='btns'>");
            out.println("<tr>");
            out.println("<td>");
            out.println("<input type='submit' class='btn' value='Submit'>");
            out.println(" </td>");
            out.println("<td>");
            out.println("<input type='reset' class='btn' value='Cancel'>");
            out.println(" </td>");
            out.println(" <td>");
            out.println("<a href='ViewIncomesCategory' class='viewtable'>View ALL</a>");
            out.println(" </td>");
            out.println("  </div>");
            out.println(" </table>");
            out.println("  </div>");
