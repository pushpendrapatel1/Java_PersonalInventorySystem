...
public class expensescategory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<form action='expensescategorycontroller' method='post'>");
            ...
            out.println(" <input type='text' placeholder='Category Name' name='c_name' required>");
            out.println(" </td>");
            out.println(" </tr>");
            out.println(" <tr>");
            out.println(" <td>");
            ...
            out.println(" </td>");
            out.println(" <td colspan='2'>");
            out.println("  <input type='text' placeholder='Category Details' name='c_details' required>");
            out.println(" </td>");
            out.println(" </tr>");
