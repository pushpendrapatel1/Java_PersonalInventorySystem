 ...
 */
public class DeleteIncomesCategory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeleteIncomesCategory</title>");
            out.println("</head>");
            out.println("<body>");
            int catid = Integer.parseInt(request.getParameter("inc_catid"));

            IncomeCategoryBean ib = new IncomeCategoryBean();
            IncomeCategoryDao id = new IncomeCategoryDao();
            int x = id.DeleteIncomeCategory(catid);
            if (x > 0) {
