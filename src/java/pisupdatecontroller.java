 ...
 */
public class pisupdatecontroller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet pisupdatecontroller</title>");
            out.println("</head>");
            out.println("<body>");
            ...
            ub.setMobile(phone);
            ub.setUserid(userid);
            int x = ud.updateUsers(ub);
            if (x > 0) {

                out.println("<h1>Sucess</h1>");
                response.sendRedirect("pisupdateuser");
            } else {
