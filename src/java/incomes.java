 ...
 */
public class incomes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("  <form class='container' action='incomescontroller'>");
            out.println("   <h1>Incomes</h1>");
           
            out.println("  <table class='datatable'>");
            out.println("  <tr>");
            out.println(" <td><label for='c_name'>Enter Incomes</label></td>");
            out.println(" <td><input type='text' id='c_name' name='inc_ac' placeholder='Enter Incomes' required></td>");
            out.println(" </tr>");
           ...
           IncomeCategoryDao ed=new IncomeCategoryDao();
            ArrayList<IncomeCategoryBean> al = ed.FindAllCategoryName(userid);
            for (IncomeCategoryBean el : al) {
                out.println(" <option value='"+el.getInc_catid()+"'>"+el.getInc_catname()+"</option>");
            }
            out.println(" </select>");
            out.println("</td>");
            out.println(" </tr>");
            ...
            out.println("  </tr>");
            out.println(" <tr>");
            out.println("   <td><label for='pay_by'>Receive By</label></td>");
            out.println(" <td>");
            out.println(" <select id='pay_by' name='receiveby'>");
